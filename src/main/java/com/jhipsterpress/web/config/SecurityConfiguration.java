...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/newsletters").permitAll()
            .antMatchers("/api/frontpageconfigs").permitAll()
            ...
            .antMatchers(HttpMethod.GET, "/feedback/new").permitAll()
//          .antMatchers(HttpMethod.GET, "/api/frontpageconfigs/*").permitAll()
//          .antMatchers(HttpMethod.GET, "/api/config-variables").permitAll()
