...
/**
 * Performance test for the Photo entity.
 */
class PhotoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Photo entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created photo")
                .get("${new_photo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created photo")
            .delete("${new_photo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
