...
import { CactivityComponent } from 'app/entities/cactivity/cactivity.component';
...
describe('Component Tests', () => {
    describe('Cactivity Management Component', () => {
        let comp: CactivityComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CactivityComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cactivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
