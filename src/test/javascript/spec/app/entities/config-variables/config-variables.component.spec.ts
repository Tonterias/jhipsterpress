...
import { ConfigVariablesComponent } from 'app/entities/config-variables/config-variables.component';
...
describe('Component Tests', () => {
    describe('ConfigVariables Management Component', () => {
        let comp: ConfigVariablesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ConfigVariablesComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.configVariables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
