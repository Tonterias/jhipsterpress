...
import { UprofileComponent } from 'app/entities/uprofile/uprofile.component';
...
describe('Component Tests', () => {
    describe('Uprofile Management Component', () => {
        let comp: UprofileComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UprofileComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.uprofiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
